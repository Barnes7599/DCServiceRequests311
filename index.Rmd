...
We can also make the heatmap interactive with just a few lines of code using the [highcharter](https://jkunst.com/highcharter/) package. Check it out! 
...
hchart(
  ...
  hc_title(
    text = "DC Service Calls (311) in 2022 by Day and Hour"
